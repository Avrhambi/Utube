...
This folder contains the Node.js server component of the UTube project — the primary backend that handles users, videos, comments, authentication, and communication with the C++ recommendation server.
